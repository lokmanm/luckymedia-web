<template>
  <div>
    <div class="about">
      <h4 class="heading-text">WHO WE ARE</h4>
      <h1 class="about-title">LuckyMedia is a design & printing agency
        <br>based in Gostivar. We design thoughtful
        <br>experiences and beautiful brand aesthetics.
      </h1>
      <h3 class="about-desc">
